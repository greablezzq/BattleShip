...
public class GameHandler {
	 ...
	 * 
	 * 1. Right-click the console, click "Preferences", or 2. (Windows) Go through
	 * Window -> Preferences -> Run/Debug -> Console, or 3. (Mac) Go through
	...
	public static void main(String[] arguments) throws Exception {
		...
		System.out
				.println("Do you want to print new turns after pressing a key, or as soon as they begin? (true/false)");
	...
	private static void drawTheFleetsAsSeenByPlayer(Player currentlyActivePlayer) {
		...
		String headline = StringManipulation.generateFleetRepresentationHeadingLine() + StringManipulation.TAB
				+ StringManipulation.TAB + StringManipulation.generateFleetRepresentationHeadingLine();
