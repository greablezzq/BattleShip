...
public class Settings {
	 ...
	 */
	public static final int PLAYING_FIELD_HORIZONTAL_SIZE = 7;

	/**
	 * Please don't make this smaller than 2.
	 */
	public static final int PLAYING_FIELD_VERTICAL_SIZE = 7;
	...
	public static final int ONE_TILE_SHIPS = 1; // Default: 0
	public static final int TWO_TILE_SHIPS = 2; // Default: 4
	public static final int THREE_TILE_SHIPS = 2; // Default: 3
	public static final int FOUR_TILE_SHIPS = 0; // Default: 2
	public static final int FIVE_TILE_SHIPS = 0; // Default: 1

	public static final String ONE_TILE_SHIP_NAME = "Boat";
	...
	public static int defaultStartingFleetStrength() {
		return (ONE_TILE_SHIPS * 1) + (TWO_TILE_SHIPS * 2) + (THREE_TILE_SHIPS * 3) + (FOUR_TILE_SHIPS * 4)
				+ (FIVE_TILE_SHIPS * 5);
	}
}
