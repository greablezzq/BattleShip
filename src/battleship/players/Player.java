...
public abstract class Player {
    ...
    public String getAccuracyInformation() {
    	String accuracyInformation="You hit "+hits+" times and miss "+misses+" times.";
    	if(hits+misses!=0) {
    		double accuracy=(double)hits/(double)(hits+misses);
    		accuracyInformation+=(" Your hit rate: "+accuracy);
    	}
    ...
    protected void placeShipRandomly(Ship ship) throws Exception {
        ...
        for (int attempts = 10000; attempts > 0; attempts--) {
